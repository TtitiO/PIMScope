...
construction. The current public runner supports LPDDR5PIM and the experimental LPDDR6PIM
  backend. Generic LPDDR6 is not interchangeable with LPDDR6PIM; the latter is
  tracked as P1-27 in `OPEN_SOURCE_READINESS_ISSUES.md` and is not used by the
  paper artifacts. The built-in dense model registry
